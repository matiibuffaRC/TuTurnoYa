  ...
  return (
    <div className="space-y-7">
            ...
            {barberos.map((b) => {
              ...
              return (
                <button
                  ...
                  disabled={cerrada}
                  className={`px-4 py-4 rounded-2xl border transition-all duration-200 relative ${
                    cerrada
                    ...
                    <div className="flex flex-col items-start">
                      <p
                        className={`font-semibold text-sm text-left ${
                          seleccionado ? "text-white" : "text-[#1e2535]"
                        }`}
                      >
                        {b.nombre} {b.apellido}
                      </p>
      ...
      <button
        ...
        onClick={onSiguiente}
        className="w-full bg-[#1e2535] text-white py-3.5 rounded-full font-semibold text-sm disabled:opacity-30 hover:bg-[#2d3748] transition-colors cursor-pointer"
      >
        Continuar
      </button>
    </div>
