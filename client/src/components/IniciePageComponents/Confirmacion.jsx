    ...
    return (
        <div className="min-h-[calc(100dvh-90px)] bg-[#f7f4ef] montserrat-alternates flex items-center justify-center px-5 py-10">
            <div className="w-full max-w-md">
                ...
                <button onClick={onNuevoTurno} className="w-full bg-[#1e2535] text-white py-3.5 rounded-xl font-semibold text-sm hover:bg-[#2d3748] transition-colors cursor-pointer">
                    Reservar otro turno
                </button>
            </div>
        </div>
