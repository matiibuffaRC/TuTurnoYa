        ...
        <div className="min-h-[calc(100vh-80px)] bg-[#f7f4ef] montserrat-alternates p-5 md:p-10">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-start justify-between mb-8">
                    ...
                    <button onClick={cerrarSesion} className="text-xs font-semibold text-[#8a8070] border border-[#e8e2d8] hover:border-[#c8c0b0] hover:text-[#1e2535] px-4 py-2 rounded-xl transition-colors cursor-pointer" >
                        Salir
                    </button>
                </div>
                ...
                <div className={`mb-5 rounded-full border px-5 py-4 flex items-center justify-between gap-4 ${agendaAbierta ? 'bg-white border-[#e8e2d8]' : 'bg-[#1e2535] border-[#1e2535]'}`}>
                    <div className="flex items-center gap-3">
                        <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 ${ agendaAbierta ? 'bg-green-50 text-green-700' : 'bg-white/10 text-amber-400' }`}>
                    ...
                    <button onClick={handleToggleAgenda} disabled={toggling} className={`text-xs font-bold px-4 py-2.5 rounded-full transition-colors cursor-pointer disabled:opacity-50 whitespace-nowrap  agendaAbierta ? 'bg-[#1e2535] hover:bg-[#2d3748]' : 'bg-white text-[#1e2535] hover:bg-[#f7f4ef]' `} >
