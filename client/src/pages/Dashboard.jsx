        ...
        <div className="min-h-[calc(100vh-80px)] bg-[#f7f4ef] montserrat-alternates p-5 md:p-10">
            <div className="max-w-4xl mx-auto">
                ...
                <div className={`mb-5 rounded-full border px-5 py-4 flex items-center justify-between gap-4 ${agendaAbierta ? 'bg-white border-[#e8e2d8]' : 'bg-[#1e2535] border-[#1e2535]'}`}>
                    ...
                    <button  onClick={handleToggleAgenda}  disabled={toggling}  className={`text-xs font-bold px-4 py-2.5 rounded-full transition-colors cursor-pointer disabled:opacity-50 whitespace-nowrap ${
                            agendaAbierta 
