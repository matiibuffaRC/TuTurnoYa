...
export default function Dashboard() {
    ...
    const { barbero, usuario, token, actualizarBarbero, logout } = useAuth();
    ...
    useEffect(() => {
        ...
        } else if (!usuario || usuario.rol !== 'SUPER_ADMIN') {
            // Neither barbero nor valid admin
            navigate("/admins-panel");
        }
    }, [navigate, token, barbero, usuario]);
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-5">
                    {[
                        ...
                        { label: 'Horario', value: barbero.sucursal?.horarioApertura && barbero.sucursal?.horarioCierre ? `${barbero.sucursal.horarioApertura} – ${barbero.sucursal.horarioCierre}` : '—' },
                    ].map((item) => (
