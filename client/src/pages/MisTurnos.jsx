                ...
                {turnos.map((t) => (
                    <div key={t.id} className="bg-white rounded-2xl border border-[#e8e2d8] px-6 py-5">
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <button onClick={() => cancelar(t.id)} className="cursor-pointer text-xs font-semibold text-red-600 border border-red-200 hover:bg-red-50 px-3.5 py-2 rounded-lg transition-colors whitespace-nowrap" >
                                Cancelar
                            </button>
                        </div>
                    </div>
