...
async function main() {
    ...
    await prisma.barbero.createMany({
        data: [
        { nombre: 'Mateo', apellido: 'Robledo', telefono: '11-1111-1111', email: 'mateo@tuturnoya.com', password: hash('mateo123'), sucursalId: suc1.id },
        { nombre: 'Nicolas', apellido: 'Bracamonte', telefono: '11-2222-2222', email: 'nicolas@tuturnoya.com', password: hash('nico123'), sucursalId: suc1.id },
